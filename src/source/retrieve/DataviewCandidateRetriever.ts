...
import { ReasonNodeType } from '../../obsidian-reason-core'
import { SourceReasonNodeSpec } from '../../reasonNode/SourceReasonNodeBuilder'
import { DataviewApi, getAPI } from 'obsidian-dataview'
import { CandidateRetriever } from '../../obsidian-reason-core/notebook'

export class DataviewCandidateRetriever implements CandidateRetriever {
  fileRenderer: FileRenderer
  dataviewAPI: DataviewApi
  constructor(settings: ReasonSettings, public app: App) {
